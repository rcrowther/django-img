...
from image.admin import widgets
#from image.admin.forms.collections import (
#    BaseCollectionMemberForm, collection_member_permission_formset_factory)
from image.fields import ImageField
from image.formats import get_image_formats
from image.models import Image
#from image.images.permissions import permission_policy as images_permission_policy
...
def formfield_for_dbfield(db_field, **kwargs):
    ...
    if db_field.name == 'file':
        return ImageField(label=capfirst(db_field.verbose_name), **kwargs)
